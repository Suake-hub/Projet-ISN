...
def jeu(niveau):
    ...
    etat = 0
    niveau, wdw, toutfini = gameplay(curX, curY, wdw, salle, porte, etat, debug, tour, curXpast, curYpast, npdt, npdtp)
    if toutfini == 1:
        print("Dans main, niveau = {0}. Il a fini ".format(niveau))
        return niveau, 1
    elif toutfini == 0 or toutfini == 2:
        print("Dans main, niveau = {0}. Il a pas fini".format(niveau))
